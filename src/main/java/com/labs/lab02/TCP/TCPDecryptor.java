...
import com.labs.lab02.UDP.UDPProcessor;
...
public class TCPDecryptor extends Thread implements Decryptor {
    ...
    public TCPDecryptor() throws NoSuchPaddingException, NoSuchAlgorithmException {
        ...
        while (true) {
            try {
                ...
                if (message != null) {
                    ...
                    TCPProcessor.queue_accept(result.getMessage());
                }
